...
<template>
  <section class="pa-3" id="main-content">
    <div>
      <v-btn class="button" to="../backend/report">
        ...
        <v-col cols="12">
          ...
          <div style="font-family: Noto Sans Lao">
            <div
              ...
              "
            >
              <p>Distribution of Loan Class By Loan Purpose By Bank</p>
            </div>
            <div>
              <div>
                <ReportPoum />
              ...
              >
                <p style="font-family: Noto Sans Lao">
                  Loan Class by Loan Purpose for ALL BANKS Based on Active Loans as
                  reported by all banks for the month of February 2024
                </p>
              </div>
            </div>
            <v-col cols="12">
