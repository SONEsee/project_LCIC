                  ...
                  <v-table density="compact" class="text-end text-no-warp">
                    ...
                    <tbody>
                      <tr v-for="(items  , index)  in item.lon_class_history">
                        ...
                        <td>{{ dayjs(items.period).format("YYYY-MM") }}</td>
...
@media print {
  ...
  /* ຮັບປະກັນວ່າຫົວເຈ້ຍແລະຕີນເຈ້ຍມີພື້ນທີ່ພຽງພໍ */
  body {
    margin: 0;
    padding: 0;
  }
  ...
  /* ປ້ອງກັນການແບ່ງໃນກຸ່ມຂໍ້ມູນສໍາຄັນ */
  ...
  /* ຮັບປະກັນການສະແດງຜົນທີ່ດີສໍາລັບລາຍລະອຽດເງິນກູ້ */
  .loan-detail-item {
    page-break-inside: avoid;
    margin-bottom: 20px;
...
/* ສະໄຕລ໌ທົ່ວໄປສໍາລັບໜ້າຈໍ */
.report-container {
  max-width: 100%;
  margin: 0 auto;
}

/* ການຄວບຄຸມການແບ່ງໜ້າແບບອ່ອນໂຍນ */
.soft-page-break {
...
/* ສໍາລັບການຈັດການເນື້ອຫາຍາວ */
.flexible-content {
  orphans: 2;
  widows: 2;
}

/* ຮັບປະກັນວ່າຫົວຂໍ້ຈະບໍ່ຖືກແຍກຈາກເນື້ອຫາ */
h1, h2, h3, h4, h5, h6 {
  page-break-after: avoid;
  orphans: 2;
}

/* ການຈັດການສໍາລັບ table ຂະໜາດໃຫຍ່ */
@media print {
  .large-table {
    page-break-inside: auto;
    font-size: 8pt;
