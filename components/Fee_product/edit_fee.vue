  ...
  <div class="fee-edit-container">
    ...
    <div class="header-section">
      <div class="d-flex align-center">
        <v-icon color="white" large class="mr-2">mdi-cash-edit</v-icon>
        <span class="text-h5 font-weight-bold" style="color: white;">ແກ້ໄຂຂໍ້ມູນຄ່າທຳນຽມ</span>
      </div>
        ...
        <v-row>
          ...
          <v-col cols="12" md="6">
            <v-text-field
              ...
              :rules="[v => !!v || 'ກະລຸນາປ້ອນປະເພດຄ່າທຳນຽມພາສາລາວ']"
            />
          </v-col>
        ...
        <!-- Charge Type (English) -->
          <v-col cols="12" md="6">
            <v-text-field
              ...
              :rules="[v => !!v || 'ກະລຸນາປ້ອນປະເພດຄ່າທຳນຽມ']"
            />
          </v-col>
    ...
    <div class="footer-section">
      ...
      <v-btn color="#2233a1" rounded :disabled="!formValid" @click="showConfirmDialog = true">
        <v-icon left>mdi-content-save</v-icon> ອັບເດດຄ່າທຳນຽມ
      </v-btn>
    </div>
      ...
      <v-card class="confirm-dialog-card" elevation="8">
        ...
        <v-card-text class="pa-4">
          ...
          <p class="text-center text-body-1 mb-0">
            ທ່ານແນ່ໃຈບໍ່ວ່າຕ້ອງການອັບເດດຂໍ້ມູນຄ່າທຳນຽມນີ້?
          </p>
        </v-card-text>
...
// Confirm and update fee
const confirmUpdateFee = async () => {
  if (!formValid.value) {
    return;
  }
  ...
  try {
    await axios.put(`${apiFeeURL}${form.value.chg_sys_id}/`, form.value);
...
const initializeForm = () => {
  form.value = {
    chg_sys_id: props.feeData.chg_sys_id,
    chg_code: props.feeData.chg_code || '',
    chg_type: props.feeData.chg_type || '',
    chg_lao_type: props.feeData.chg_lao_type || '',
    chg_desc: props.feeData.chg_desc || '',
    chg_lao_desc: props.feeData.chg_lao_desc || '',
    chg_amount: props.feeData.chg_amount ?? null,
    chg_unit: props.feeData.chg_unit || '',
  };
};

// Clear form (reset to original feeData)
const clearForm = () => {
  initializeForm();
