        ...
        <v-window-item value="two">
          ...
          <v-window v-model="subTab">
            ...
            <v-window-item value="two-two">
              ...
              >
              <h3 class="mt-5">
                ຂໍ້ມູນ <b> GOLD AND SILVER.</b>ບໍຖືກ ແລະບໍ່ມີ LcicID
              </h3>
              :
              <v-col cols="12">
                <v-row>
            ...
            <v-window-item value="two-three">
              <h3>
                ຂໍ້ມູນ <b> GOLD AND SILVER.</b> ທີ່ມີ LCICID ແລະ
            ...
            <v-window-item value="two-five">
              <h3>
                ...
                customer_id, loan_id ແຕ່ມີ LCICID ແລະ com_enterprise_code ບໍ່ຖືກ
              </h3>
