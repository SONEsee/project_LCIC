    ...
    <v-card-text>
      <v-window v-model="tab">
        ...
        <v-window-item value="two">
          ...
          <v-window v-model="subTab">
            ...
            <v-window-item value="two-two">
              ...
              <h3 class="mt-5">ຂໍ້ມູນ <b> ໂຄງການ.</b>ບໍຖືກ ແລະບໍ່ມີ LCIC_code</h3>
              :
              <v-col cols="12">
                <v-row>
            ...
            <v-window-item value="two-three">
              <h3>
                ຂໍ້ມູນ <b> ໂຄງການ.</b> ທີ່ມີ LCIC_code ແລະ
            ...
            <v-window-item value="two-five">
              <h3>
                ຂໍ້ມູນ <b> ໂຄງການ.</b>ທີ່ມີ bnk_code, branch_id, customer_id,
                loan_id ແຕ່ມີ LCIC_code ແລະ com_enterprise_code ບໍ່ຖືກ
              </h3>
        ...
        <v-window-item value="three">
          ...
          <v-data-table :items="prj" :headers="headers6">
            <template v-slot:header.id>
              <th style="color: #0d47a1">ID</th>
            </template>
            <template v-slot:header.LCIC_code>
