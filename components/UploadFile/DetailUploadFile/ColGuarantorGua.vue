          ...
          <v-window-item value="two">
            ...
            <v-window v-model="subTab">
              ...
              >
                ...
                <h3 class="mt-5">ຂໍ້ມູນ <b> ຜູ້​ຄ້ຳປະກັນ.</b>ບໍຖືກ ແລະບໍ່ມີ LCIC_code </h3>:
                <v-col cols="12">
                  <v-row>
              ...
              <v-window-item value="two-three">
                <h3>
                  ຂໍ້ມູນ <b> ຜູ້​ຄ້ຳປະກັນ.</b> ທີ່ມີ LCIC_code ແລະ com_enterprise_code_error ຜິດ ຫຼື ບໍ່ມີ
                </h3>
    ...
    const headers6 = [
      ...
      const combinedData = computed(() => {
        const filteredCerror = (cerror.value || []).filter(
          (item) =>item.col_type === "C2.6" ||item.col_type === "c2.6"
        );
    ...
    const gua = computed(() => {
        ...
        return cerror.value
          .filter(
            (item) =>
              (item.collateral_status === "31" ||
                item.collateral_status === "10") &&
             item.col_type === "C2.6" ||item.col_type === "c2.6"
          )
      ...
      const lcicerror = computed(() => {
        return cerror.value
          .filter(
            (item) =>
             ( item.collateral_status === "13" ||item.collateral_status === "01") &&item.col_type === "C2.6" ||item.col_type === "c2.6"
          )
