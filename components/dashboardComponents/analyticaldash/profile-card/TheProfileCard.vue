  ...
  <v-card>
    ...
    <v-card-text>
      <div class="p-4 text-center justify-center">
        <h2 class="mb-0 mt-4 font-weight-regular">sone</h2>
        <small>Web Designer &amp; Developer</small><br />
        <v-btn rounded color="primary" class="mt-4 px-7 mx-auto">ຕິດຕາມ</v-btn>
        <v-row class="mt-6 pb-4">
          <v-col cols="4">
            <h2 class="mb-0">1099</h2>
            <small class>ບົດຄວາມ</small>
          </v-col>
          <v-col cols="4">
            <h2 class="mb-0">23,469</h2>
            <small class>ຜູ້ຕິດຕາມ</small>
          </v-col>
          <v-col cols="4">
            <h2 class="mb-0">6035</h2>
            <small class>ກຳລັງຕິດຕາມ</small>
          </v-col>
        </v-row>
      </div>
    </v-card-text>
