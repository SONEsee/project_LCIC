<template>
      ...
      <div class="print-reference-item">
        <strong>Type:</strong> {{ getReportTypes() }}
            ...
            <v-card
              ...
              class="report-section mb-4 page-break-before"
              elevation="3"
            >
              ...
              <v-card-text class="report-content">
                ...
                <!-- Chart Section - Hide on Print -->
                <div class="chart-section mt-4" v-if="waterReport.bill && waterReport.bill.length > 0">
            ...
            >
              ...
              <v-card-text class="report-content">
                ...
                <!-- Chart Section - Hide on Print -->
                <div class="chart-section mt-4" v-if="electricReport.bill && electricReport.bill.length > 0">
                  <h4 class="chart-title">ກາຟິກສະແດງຂໍ້ມູນ</h4>
                  <div class="chart-container">
                    <VueApexCharts
                      type="bar"
            ...
            <!-- Professional Footer -->
            <v-card v-if="hasAnyResults && !isLoading" class="footer-section" elevation="4">
  ...
  const getProcessedBills = (bills: any[]) => {
    ...
    return bills.map(bill => ({
      ...bill,
      totalAmount: (parseFloat(bill.Outstanding || '0') + parseFloat(bill.Basic_Tax || '0')).toString(),
      status: parseFloat(bill.Outstanding || '0') === 0 ? 'Paid' : 'Unpaid'
    })).sort((a, b) => {
  ...
  const prepareApexChartData = (bills: any[]) => {
    ...
    const processedBills = getProcessedBills(bills).slice(0, 6).reverse()
