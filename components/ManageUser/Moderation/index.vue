      ...
      <tbody>
        ...
        >
          ...
          <td class="border border-gray-400 px-4 py-2">
            <v-btn
              @click="editItem(item)"
              class="px-2 py-1 bg-blue-darken-4 rounded hover:bg-green-600 mr-2 "
            >
            ...
            <v-btn
              ...
              class="px-2 py-1 bg-red-accent-4 rounded hover:bg-red-600"
            >
...
const rolesApi = `${config.public.strapi.url}api/roles/`;
const sidebarItemsApi = `${config.public.strapi.url}api/sidebar-items/`;
const updateSidebarApi = `${config.public.strapi.url}api/create_sidebar/`; 
...
const addSidebarItem = async () => {
  ...
  if (formValues) {
    ...
    try {
      const config = useRuntimeConfig();
      const response = await axios.post(`${config.public.strapi.url}api/create_sidebar/`, payload);
