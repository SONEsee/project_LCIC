    ...
    <v-row class="justify-center">
      ...
      <v-col cols="12" sm="6" md="4" lg="3">
        ...
        ></v-select>
          ...
          <v-card-actions>
            <v-btn block color="success" class="mt-2" :disabled="!selectedProvince || !selectedDistrict || !dateRequest" @click="downloadJSONWithParams">
              ດາວໂຫລດ ບິນໄຟຟ້າ
            </v-btn>
          </v-card-actions>
        </v-card>
      ...
      <v-col cols="12" sm="6" md="4" lg="3">
        ...
        ></v-select>
          ...
          <v-card-actions>
            <v-btn block color="success" class="mt-2" :disabled="!cus_selectedProvince || !cus_selectedDistrict || !cus_dateRequest" @click="downloadCusJSONWithParams">
              ດາວໂຫລດ ລູກຄ້າໄຟຟ້າ
            </v-btn>
          </v-card-actions>
        </v-card>
...
const downloadCusJSONWithParams = () => {
  ...
  fetchAndDownloadEDL(apiUrl, `electric-bill-${cus_selectedProvince.value}-${cus_selectedDistrict.value}-${cus_dateRequest.value}.json`);
};
