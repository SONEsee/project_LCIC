...
export default defineComponent({
  setup() {
    ...
    const headers = ref([
      ...
      { text: "ສະຖານະການຢືນຢັນ", value: "statussubmit" },
...
=======
        ...
        try {
          const response = await axios.post('http://192.168.45.56:8000/api/upload-files/', formData);
          ...
          const response2 = await fetch('http://192.168.45.56:8000/api/api/upload-files2/');
...
=======
        ...
        try {
          const response = await axios.get('http://192.168.45.56:8000/api/api/productinfo3/', {
>>>>>>> 8b48fd2a1696bc13a6659c284560aa69db42d491
            params: {
              FID: item.FID,
            },
...
=======
          ...
          if (result.isConfirmed) {
            try {
              ...
              const response = await axios.post('http://192.168.45.56:8000/api/confirm_upload/', params);
...
<<<<<<< HEAD
  Swal.fire(
    ...
    location.reload();
=======
        const response = await axios.post('http://192.168.45.56:8000/api/api/update-statussubmit/', `FID=${item.FID}`);
      ...
      // };
      const getFullPath = (path: string) => `http://192.168.45.56:8000/${path}`;
