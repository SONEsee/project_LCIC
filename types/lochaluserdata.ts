...
export class Convert {
    public static toUserDataRespons(json: string): UserDataRespons {
        return cast(JSON.parse(json), r("UserDataRespons"));
    }

    public static userDataResponsToJson(value: UserDataRespons): string {
        return JSON.stringify(uncast(value, r("UserDataRespons")), null, 2);
    }
}
...
const typeMap: any = {
    "UserDataRespons": o([
        ...
        { json: "MID", js: "MID", typ: r("Mid") },
        { json: "GID", js: "GID", typ: r("Gid") },
        { json: "username", js: "username", typ: "" },
        { json: "nameL", js: "nameL", typ: "" },
        { json: "nameE", js: "nameE", typ: "" },
        { json: "surnameL", js: "surnameL", typ: "" },
        { json: "surnameE", js: "surnameE", typ: "" },
        { json: "is_active", js: "is_active", typ: true },
        { json: "last_login", js: "last_login", typ: Date },
        { json: "is_staff", js: "is_staff", typ: true },
        { json: "is_superuser", js: "is_superuser", typ: true },
    ], false),
    "Gid": o([
